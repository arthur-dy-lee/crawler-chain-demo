...
//        this.addSeed("https://explorer.zcha.in/");
//
//        /**
//         * 循环添加了4个种子，其实就是分页，结果类似：
//         * https://explorer.zcha.in/page/2/
//         * https://explorer.zcha.in/page/3/
//         * https://explorer.zcha.in/page/4/
//         * https://explorer.zcha.in/page/5/
//         */
////        for (int pageIndex = 2; pageIndex <= 5; pageIndex++) {
////            String seedUrl = String.format("https://explorer.zcha.in/page/%d/", pageIndex);
////            this.addSeed(seedUrl);
////        }
//
//        /** addRegex 参数为一个 url 正则表达式, 可以用于过滤不必抓取的链接，如 .js .jpg .css ... 等
//         * 也可以指定抓取某些规则的链接，如下 addRegex 中会抓取 此类地址：
//         * https://explorer.zcha.in/2018-07-13-graphql-for-octokit/
//         * */
//        this.addRegex("https://explorer.zcha.in/[0-9]{4}-[0-9]{2}-[0-9]{2}-[^/]+/");
//        /**
...
//         */
//        if (page.matchUrl("https://explorer.zcha.in/accounts/t1RP5gmbnodM5eaajzQ9DoUChGzEtmnjzSH")) {
//
//            /**
...
//         * */
//        DemoAutoNewsCrawler crawler = new DemoAutoNewsCrawler("https://explorer.zcha.in/accounts/t1RP5gmbnodM5eaajzQ9DoUChGzEtmnjzSH", true);
//        /**
//         * 启动爬虫，爬取的深度为4层
//         * 添加的第一层种子链接,为第1层
//         */
